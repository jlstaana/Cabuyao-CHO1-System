  ...
  return (
    <footer className={`border-t border-slate-200 bg-slate-950 text-slate-300 ${className}`}>
          ...
          <div className="mt-4 space-y-4 text-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-slate-400">Online portal access is available for registered patients and authorized CHO staff.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-white/10 px-6 py-3">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-3 text-xs text-slate-500 md:flex-row md:items-center md:justify-between">
