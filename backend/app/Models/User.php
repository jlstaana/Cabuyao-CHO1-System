...
class User extends Authenticatable {
    ...
    protected $fillable = ['name', 'email', 'password', 'role', 'first_login', 'is_active', 'email_verified_at', 'email_verification_code_hash', 'email_verification_code_expires_at', 'profile_picture'];
